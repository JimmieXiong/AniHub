    ...
    extract(videoUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { data: srcsData } = yield this.client.get(megacloud.sources.concat(videoId || ""), {
                    headers: {
                        Accept: "*/*",
                ...
                const { data } = yield this.client.get(megacloud.script.concat(Date.now().toString()));
                const text = data;
                if (!text)
    ...
    extract2(embedIframeURL) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const resp = yield (0, megacloud_getsrcs_1.getSources)(xrax);
                if (!resp)
