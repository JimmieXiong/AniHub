...
const aniwatchtvRoutes_1 = require("./aniwatchtvRoutes");
const headers_1 = require("../config/headers");
const embed_url = "https://megacloud.tv/embed-2/e-1/";
const referrer = aniwatchtvRoutes_1.BASE_URL;
const user_agent = headers_1.headers.USER_AGENT_HEADER;
...
function QN(QP, Qn) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return "function" == typeof Response && isResponse(QP)
            ? ((QT = yield QP.arrayBuffer()),
                (Qt = yield WebAssembly.instantiate(QT, Qn)),
                Object.assign(Qt, { bytes: QT }))
            : (Qt = yield WebAssembly.instantiate(QP, Qn)) instanceof
...
function loadWasm(url) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { instance, bytes } = yield QN(yield response, mod);
        assignWasm(instance);
        return bytes;
    });
}
...
const V = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let Q0 = yield wasmLoader("https://megacloud.tv/images/loading.png?v=0.0.9");
...
const getMeta = (url) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
function getSources(xrax) {
    return __awaiter(this, void 0, void 0, function* () {
        yield getMeta(embed_url + xrax + "?k=1");
        ...
        try {
            ...
            let getSourcesUrl = "https://megacloud.tv/embed-2/ajax/e-1/getSources?id=" +
                ...
                "&b=" +
                browser_version;
            let resp_json = yield (yield fetch(getSourcesUrl, {
                headers: {
